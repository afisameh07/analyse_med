...
if (isset($_POST["enreg_classe"])) {
    ...
    $sql = "UPDATE utilisateurs SET np='$np', tel='$tel', adresse='$adresse', pwd='$pwd', description='$description' WHERE id='".$idd."'";
    ...
    $sql = "INSERT INTO utilisateurs (np, type, tel, adresse, login, pwd,description) VALUES ('$np', '4', '$tel', '$adresse','$login','$pwd','$description')";
